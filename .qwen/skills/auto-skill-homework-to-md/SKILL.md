---
name: homework-to-md
description: 将作业/习题/考试 PDF 转换为项目标准 Markdown 格式。处理公式渲染、equation 序号清理、格式规范化等问题。
source: auto-skill
extracted_at: '2026-06-14T00:11:17.629Z'
---
...
### 步骤 1.5：提取 PDF 中的图片（如需要）

如果 PDF 中包含函数图像、几何图形等需要保留的图片，使用 `pdfplumber` 提取：
...
- **PDF 图片提取**：`.qwen/skills/auto-skill-pdf-image-extract/SKILL.md`（提取函数图像、几何图形）
